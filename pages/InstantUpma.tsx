...
const InstantUpma: React.FC = () => {
  return (
    <div className="bg-neutral-950 text-neutral-300 overflow-hidden perspective-1000 pb-16">
        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 md:px-12">
          ...
          <div className="block lg:hidden flex flex-col items-center text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-orange-500/20 bg-orange-500/5 backdrop-blur-sm mb-6">
              <Sprout className="w-4 h-4 text-orange-500 animate-pulse" />
              <span className="text-xs font-black uppercase tracking-[0.3em] text-orange-400">Agro Division</span>
            </div>
            <h1 className="text-5xl sm:text-6xl font-black tracking-tighter uppercase leading-[0.9] text-white">
              DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600 drop-shadow-lg">Instant</span><br />
              <span className="text-3xl sm:text-4xl text-white/50 tracking-tight">Upma</span>
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
            ...
            <div className="flex flex-col items-start text-left order-2 lg:order-1">
              <FadeInSection>
                <div className="bg-neutral-900/30 backdrop-blur-xl border border-white/[0.08] p-6 md:p-8 rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.8)] relative overflow-hidden group hover:border-orange-500/30 transition-all duration-700">
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    ...
                    <div className="hidden lg:flex flex-col items-start">
                      ...
                      <h1 className="text-5xl md:text-7xl lg:text-[5rem] font-black tracking-tighter uppercase leading-[0.9] mb-8 text-white">
                        DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-orange-600 drop-shadow-lg">Instant</span><br />
                        <span className="text-3xl md:text-5xl text-white/50 tracking-tight">Upma</span>
                      </h1>
                    </div>
                    ...
                    <p className="text-neutral-300 max-w-xl text-lg md:text-xl font-light leading-relaxed mb-10 transition-all duration-300 hover:text-white">
                      DXN Instant Upma is a tasty and healthy breakfast made with suji, lentils, and vegetables like onion, garlic, and green chilli. It's quick to make and packed with nutrients. The added nuts give it a nice crunch. No artificial preservatives, just a wholesome, vegetarian-friendly meal to start your day!
                    </p>
              ...
              <FadeInSection delay="200ms">
                <div className="relative w-full max-w-xl aspect-[4/5] lg:aspect-square group">
                  <div className="relative w-full h-full flex items-center justify-center transform transition-transform duration-700 hover:scale-[1.05]">
                    <img
                      src="/agro/Upma.png"
                      alt="DXN Instant Upma"
                      className="w-full h-full object-contain rounded-[2rem] filter drop-shadow-[0_20px_40px_rgba(249,115,22,0.25)]"
                    />
                  </div>
                </div>
              </FadeInSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24 self-start">
            <FadeInSection>
              <div className="relative group">
                <div className="absolute -inset-2 bg-gradient-to-r from-orange-500/5 to-amber-500/5 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none"></div>
                <div className="bg-neutral-900/25 backdrop-blur-xl border border-white/[0.06] p-4 md:p-6 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.4)] relative overflow-hidden transition-all duration-500 hover:border-orange-500/20 hover:shadow-[0_25px_60px_rgba(0,0,0,0.5)]">
                  {/* Floating Particles */}
                  <div className="absolute inset-0 pointer-events-none z-0">
                    <Droplet className="absolute top-[20%] left-[20%] w-3 h-3 text-orange-400/30 animate-float delay-100 filter blur-[1px]" />
                    <Droplet className="absolute bottom-[30%] right-[15%] w-4 h-4 text-orange-400/20 animate-float-delayed delay-300 filter blur-[1.5px]" />
                    <Sprout className="absolute top-[40%] right-[20%] w-5 h-5 text-orange-500/20 animate-float delay-500" />
            ...
            <FadeInSection delay="200ms">
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                ...
                <ul className="space-y-4 relative z-10">
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 hover:border-orange-500/20 transition-colors">
                    <span className="text-neutral-400 font-medium">Appearance</span>
                    <span className="text-white font-medium text-right max-w-[55%] leading-snug">Dry granular structure with Creamish white colour</span>
                  </li>
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 hover:border-orange-500/20 transition-colors">
                    <span className="text-neutral-400 font-medium">Colour and Odour</span>
                    <span className="text-white font-medium">Cream white colour</span>
                  </li>
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 hover:border-orange-500/20 transition-colors">
                  ...
                  <li className="flex justify-between items-center text-sm pb-1 transition-colors">
                    ...
                    <span className="text-white font-medium">Savoury Porridge</span>
                  </li>
                </ul>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay="300ms">
              <div className="bg-neutral-900/30 backdrop-blur-xl border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-orange-500/25 hover:shadow-[0_20px_50px_rgba(249,115,22,0.06)] hover:-translate-y-0.5 relative overflow-hidden group">
                <div className="absolute -top-12 -right-12 w-32 h-32 bg-orange-600/5 rounded-full blur-2xl group-hover:bg-orange-600/10 transition-colors duration-500"></div>
                <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-amber-500/50 pl-3">
                  <ShieldCheck className="w-4 h-4 text-orange-500" /> Allergen Information
                </h3>

                <div className="flex items-start gap-3 bg-neutral-900/50 border border-white/10 p-4 rounded-xl relative z-10 mb-6 border-l-[3px] border-l-yellow-500/50">
                  <AlertTriangle className="w-4 h-4 text-yellow-500 shrink-0 mt-0.5" />
                  <div>
                    <h4 className="text-[10px] font-bold text-white uppercase tracking-wider mb-1">Contains</h4>
                    <p className="text-[11px] text-neutral-300 font-medium tracking-wide">Nuts, Milk & Mustard</p>
                  </div>
                </div>
          ...
          <div className="lg:col-span-7">
            <div className="mb-12">
              <FadeInSection>
                ...
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-4">
                  DXN Instant Upma is a Savory porridge made with Suji and vegetables (onion, garlic & green Chilli). Instant upma is a healthy, nutritious and a delicious breakfast option that is easy to make and perfect to start the day off right.
                </p>
                <p className="text-neutral-400 text-sm font-light leading-relaxed mb-8">
                  The addition of the nuts adds a nice crunch, and lentils (dals) and vegetables make it healthier and makes it more delicious. Pre-packed ready-to-eat Upma comes in a 90g paper cup, with a sealed lid and disposable wooden spoon.
                </p>
              </FadeInSection>
              ...
              <FadeInSection delay="100ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] rounded-xl p-5 flex gap-6 divide-x divide-white/[0.06]">
                  ...
                  <div className="flex-1 pl-6">
                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 mb-1">FSSAI Category</h4>
                    <p className="text-base font-bold text-white">Savoury Porridge</p>
                  </div>
                </div>
              </FadeInSection>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              ...
              <FadeInSection delay="300ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 h-full group">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-amber-500/50 pl-3">
                    <Leaf className="w-4 h-4 text-orange-500" /> Ingredients
                  </h3>
              ...
              <FadeInSection delay="400ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 h-full group">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-amber-500/50 pl-3">
                    <ShieldCheck className="w-4 h-4 text-orange-500" /> Storage &amp; Usage
                  </h3>
                  <div className="space-y-6 text-sm text-neutral-300">
                    <div className="group/item">
                      <h5 className="font-bold text-white mb-3 uppercase text-[9px] tracking-widest group-hover/item:text-orange-400 transition-colors">Directions for Use</h5>
                      <ol className="list-decimal pl-4 space-y-2 marker:text-orange-500">
                        <li>Pour the DXN Instant Upma into a cup and add 160-180 ml of very hot water according to consistency.</li>
                        <li>Stir it well and cover with a lid.</li>
                        <li>After 5-10 minutes, open the lid, stir it well and consume.</li>
                      </ol>
                    </div>
            ...
            <FadeInSection delay="500ms">
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-orange-500/20 hover:bg-neutral-900/50 group">
                <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-amber-500/50 pl-3">
                  <ShieldCheck className="w-4 h-4 text-orange-500" /> Key Benefits
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    { title: 'Healthy Breakfast', desc: 'Packed with nutrients and wholesome ingredients' },
                    { title: 'No Preservatives', desc: 'Free from artificial preservatives' },
                    { title: 'Quick &amp; Easy', desc: 'Ready to eat in just 5-10 minutes' },
                    { title: 'Vegetarian Friendly', desc: 'A perfect meal to start your day' },
                  ].map((benefit, idx) => (
                    <div key={idx} className="flex items-start gap-3 p-4 bg-white/[0.02] rounded-xl border border-white/[0.04] hover:border-orange-500/20 transition-colors">
      ...
      `}</style>
      <ProductReviews productName="Instant Upma" />
    </div>
  );
};

export default InstantUpma;
