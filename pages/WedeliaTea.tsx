...
import { Package, Check, ShieldCheck, Coffee, Info, AlertTriangle, Sparkles, ChevronLeft, ChevronRight, ArrowRight, HeartPulse } from 'lucide-react';
...
const WedeliaTea: React.FC = () => {
  return (
    <div className="bg-neutral-950 text-neutral-300 overflow-hidden perspective-1000 pb-16">
        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 md:px-12">
          ...
          <div className="block lg:hidden flex flex-col items-center text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-amber-500/20 bg-amber-500/5 backdrop-blur-sm mb-6">
              ...
              <span className="text-xs font-black uppercase tracking-[0.3em] text-amber-400">Coffee & Tea Division</span>
            </div>
            <h1 className="text-5xl sm:text-6xl font-black tracking-tighter uppercase leading-[0.9] text-white">
              DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-amber-600 drop-shadow-lg">Wedelia Floral Tea</span>
            </h1>
          </div>
                ...
                <div className="bg-neutral-900/30 backdrop-blur-xl border border-white/[0.08] p-6 md:p-8 rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.8)] relative overflow-hidden group hover:border-amber-500/30 transition-all duration-700">
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    ...
                    <p className="text-neutral-300 max-w-xl text-lg md:text-xl font-light leading-relaxed mb-10 transition-all duration-300 hover:text-white">
                      Each paper canister box contains 30g of premium dried Wedelia flowers, traditionally known for their calming and relaxing properties.
                    </p>
              ...
              <FadeInSection delay="200ms">
                <div className="relative w-full max-w-lg aspect-[4/5] lg:aspect-square group">
                  ...
                  <div className="relative w-full h-full flex items-center justify-center transform transition-transform duration-700 hover:scale-[1.05]">
                    <img
                      src="/coffee/wedelia.png"
                      alt="DXN Wedelia Floral Tea Packaging"
                      className="w-full h-full object-contain scale-[1.1] md:scale-[1.15] filter drop-shadow-[0_20px_40px_rgba(245,158,11,0.3)]"
                    />
                  </div>
                </div>
              </FadeInSection>
          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24 self-start">
            <FadeInSection>
              ...
              <div className="relative group">
                ...
                <div
                  className="bg-neutral-900/25 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.4)] relative overflow-hidden transition-all duration-500 hover:border-amber-500/20 hover:shadow-[0_25px_60px_rgba(0,0,0,0.5)]"
                >
                  {/* Ambient glow */}
                  <div className="absolute -inset-2 bg-gradient-to-br from-amber-500/5 via-transparent to-transparent blur-2xl pointer-events-none"></div>
                  ...
                  <div className="relative z-10 w-full aspect-video rounded-2xl overflow-hidden shadow-2xl bg-black border border-white/5 flex items-center justify-center">
                    <video
                      src="/coffee/Wedelia_tea.mp4"
                      // alt="DXN Wedelia Floral Tea"
                  ...
                  <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-3/4 h-8 bg-amber-600/20 blur-2xl rounded-full"></div>
                </div>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay="200ms">
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 transition-colors group-hover:text-white border-l-2 border-amber-500/50 pl-3">
                  <Info className="w-4 h-4 text-amber-500" /> Physical Attributes
                </h3>
                <ul className="space-y-4 relative z-10">
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-amber-500/20">
                    ...
                    <span className="text-white font-medium text-right">Dried Wedelia flowers</span>
                  </li>
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-amber-500/20">
                    <span className="text-neutral-400 font-medium transition-colors group-hover/item:text-neutral-200">Colour and Odour</span>
                    <span className="text-white font-medium text-right">Yellow to Orange, subtle fragrant aroma</span>
                  </li>
            ...
            <FadeInSection delay="300ms">
              <div className="bg-neutral-900/30 backdrop-blur-xl border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-amber-500/25 hover:shadow-[0_20px_50px_rgba(245,158,11,0.06)] hover:-translate-y-0.5 relative overflow-hidden group">
                ...
                <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-amber-500/50 pl-3">
                  <ShieldCheck className="w-4 h-4 text-amber-500" /> Servings Information
                </h3>
            ...
            <div className="mb-12">
              <FadeInSection>
                ...
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-6">
                  Wedelia Floral Tea is made from the dried flowers of the Wedelia plant. This naturally aromatic flower brews into a delicate, fragrant tea with a mild floral taste. Known for its calming properties, Wedelia Floral Tea promotes relaxation and supports overall well-being. It's rich in nutrients that help enhance immune health and provide a soothing experience, making it an ideal choice for any time of day.
                </p>
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-8">
                  DXN Wedelia is a mat forming perennial herb with rounded stems. Flowers are Yellow-Orange in color with 8-13 florets. Wedelia is a medicinal plant that has been used in traditional medicine for centuries. It is well known for its antioxidant and anti-inflammatory properties.
                </p>
              </FadeInSection>
            ...
            <div className="grid grid-cols-1 gap-6 mb-12">
              ...
              <FadeInSection delay="200ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-amber-500/50 pl-3">
                    <HeartPulse className="w-4 h-4 text-amber-500" /> Health Benefits
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    {[
                      { title: 'Promotes Relaxation', desc: 'Known for its calming effects, Wedelia Floral Tea helps reduce stress and anxiety, promoting a peaceful mind and body.' },
                      { title: 'Supports Immune Health', desc: 'Rich in natural nutrients, it helps strengthen the immune system and enhances overall wellness.' },
                      { title: 'Improves Sleep Quality', desc: 'The soothing properties of Wedelia flowers may help improve sleep, making it an ideal evening beverage.' },
                      { title: 'Aids Digestion', desc: 'Known to support healthy digestion, it may help alleviate mild digestive discomfort.' },
                      { title: 'Rich in Antioxidants', desc: 'Contains antioxidants that protect cells from oxidative damage and support overall health.' },
                    ].map((benefit, idx) => (
                      <div key={idx} className="flex flex-col gap-1 p-3 bg-white/[0.02] border border-white/[0.04] rounded-lg hover:border-amber-500/20 transition-colors">
                        <span className="text-sm font-bold text-white flex items-center gap-2">
                          <Check className="w-3.5 h-3.5 text-amber-500 shrink-0" /> {benefit.title}
                        </span>
                ...
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 h-full group">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3 text-sm group/item">
                      ...
                      <span className="font-semibold text-white block group-hover/item:translate-x-1 transition-transform">Sun Dried Wedelia flowers</span>
                    </li>
                  </ul>
                </div>
              </FadeInSection>
                  ...
                  <div className="space-y-6 text-sm text-neutral-300">
                    <div className="group/item">
                      ...
                      <div className="space-y-4">
                        {[
                          { step: 1, label: 'Add Flowers', desc: 'Add 5-6 dried DXN Wedelia flowers to 150 ml of hot water.' },
      ...
      <ProductReviews productName="Wedelia Floral Tea" />
    </div>
  );
};

export default WedeliaTea;
