...
const Lemonzhi: React.FC = () => {
  return (
    <div className="bg-neutral-950 text-neutral-300 overflow-hidden perspective-1000 pb-16">
        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 md:px-12">
          ...
          <div className="block lg:hidden flex flex-col items-center text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="text-5xl sm:text-6xl font-black tracking-tighter uppercase leading-[0.9] text-white">
              DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 to-yellow-600 drop-shadow-lg">Lemonzhi</span>
            </h1>
          </div>
                ...
                <div className="bg-neutral-900/30 backdrop-blur-xl border border-white/[0.08] p-6 md:p-8 rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.8)] relative overflow-hidden group hover:border-yellow-500/30 transition-all duration-700">
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    ...
                    <p className="text-neutral-300 max-w-xl text-lg md:text-xl font-light leading-relaxed mb-10 transition-all duration-300 hover:text-white">
                      500 gm Powder form of Lemonzhi Powder (Each Sachet Contains 20 gm).
                    </p>
              ...
              <FadeInSection delay="200ms">
                <div className="relative w-full max-w-lg aspect-[4/5] lg:aspect-square group">
                  ...
                  <div className="relative w-full h-full flex items-center justify-center transform transition-transform duration-700 hover:scale-[1.05]">
                    <img
                      src="/coffee/lemonZhi.png"
                      alt="DXN Lemonzhi Packaging"
                      className="w-full h-full object-contain scale-[1.1] md:scale-[1.15] filter drop-shadow-[0_20px_40px_rgba(234,179,8,0.3)]"
                    />
                  </div>
                </div>
              </FadeInSection>
          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24 self-start">
            <FadeInSection delay="200ms">
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 transition-colors group-hover:text-white border-l-2 border-red-500/50 pl-3">
                ...
                <ul className="space-y-4 relative z-10">
                  ...
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-red-500/20">
                    ...
                    <span className="text-white font-medium text-right">Brown and Lemon Aroma</span>
                  </li>
            ...
            <div className="mb-12">
              <FadeInSection>
                ...
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-6">
                  DXN Lemonzhi is a healthy beverage designed to invigorate the brain and body, featuring lemon powder, instant tea, Sugar and Ganoderma Extract.
                </p>
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-8">
                  ...
                  DXN Lemonzhi is specially formulated lemon powder with the addition of instant tea and Ganoderma Extract. It is a refreshingly delicious beverage for you.
                </p>
              </FadeInSection>
                    ...
                    <div className="group/item">
                      ...
                      <div className="space-y-4">
                        <div className="flex gap-4 items-start">
                          ...
                          <div>
                            <p className="text-xs font-semibold text-white">Hot / Warm</p>
                            <p className="text-xs text-neutral-400">Pour the Contents of DXN Lemonzhi in a cup. Add 150ml hot/ warm water and stir well.</p>
                          </div>
                        </div>
                        <div className="flex gap-4 items-start">
                          <span className="w-5 h-5 rounded-full bg-red-500/10 border border-red-500/30 text-red-500 flex items-center justify-center text-[10px] font-bold shrink-0">
                          ...
                          <div>
                            <p className="text-xs font-semibold text-white">Cold</p>
                            <p className="text-xs text-neutral-400">Pour the Contents of DXN Lemonzhi in a cup. Add 150ml Cool Water/May add ice (stir well) for better taste.</p>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <ProductReviews productName="Lemonzhi" />
    </div>
  );
};

export default Lemonzhi;
