...
const SpirulinaCapsule: React.FC = () => {
  return (
    <div className="bg-neutral-950 text-neutral-300 overflow-hidden perspective-1000 pb-16">
        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 md:px-12">
          ...
          <div className="block lg:hidden flex flex-col items-center text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-500/20 bg-blue-500/5 backdrop-blur-sm mb-6">
              ...
              <span className="text-xs font-black uppercase tracking-[0.3em] text-blue-400">FSSAI</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-black tracking-tighter uppercase leading-[0.9] text-white">
              DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-600 drop-shadow-lg">SPIRULINA</span><br />
              <span className="text-2xl sm:text-3xl text-white/50 tracking-tight">CAPSULE</span>
            </h1>
          </div>
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    <div className="hidden lg:flex flex-col items-start">
                      ...
                      <h1 className="text-4xl md:text-6xl lg:text-[4.5rem] font-black tracking-tighter uppercase leading-[0.9] mb-8 text-white">
                        DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-600 drop-shadow-lg">SPIRULINA</span><br />
                        <span className="text-2xl md:text-4xl text-white/50 tracking-tight">CAPSULE</span>
                      </h1>
                    </div>
                    ...
                    <p className="text-neutral-300 max-w-xl text-lg md:text-xl font-light leading-relaxed mb-10 transition-all duration-300 hover:text-white">
                      It helps to boost energy levels and promotes weight management. Moreover, it may help to regulate blood sugar and cholesterol levels of the body.
                    </p>
              ...
              <FadeInSection delay="200ms">
                <div className="relative w-full max-w-lg aspect-[4/5] lg:aspect-square group">
                  <div className="relative w-full h-full flex items-center justify-center transform transition-transform duration-700 hover:scale-[1.05]">
                    <img
                    src="/nutra/Spirulina120Capsule.png"
                    alt="DXN Spirulina Capsule"
                    onError={(e) => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24 self-start">
              ...
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                ...
                <ul className="space-y-4 relative z-10">
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-blue-500/20">
                    ...
                    <span className="text-white font-medium text-right">Blue green to green colour capsule</span>
                  </li>
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-blue-500/20">
                    <span className="text-neutral-400 font-medium transition-colors group-hover/item:text-neutral-200">Colour and taste</span>
                    <span className="text-white font-medium text-right">Blue green to green colour & mild seaweed smell and taste</span>
                  </li>
            ...
            <FadeInSection delay="300ms">
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 transition-colors group-hover:text-white border-l-2 border-blue-500/50 pl-3">
                  <ShieldCheck className="w-4 h-4 text-blue-500" /> Quality & Safety
                </h3>
                <ul className="space-y-4 relative z-10">
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-blue-500/20">
                    <span className="text-neutral-400 font-medium transition-colors group-hover/item:text-neutral-200">Lab Report Available</span>
                    <span className="text-white font-medium text-right flex items-center gap-1"><Check className="w-4 h-4 text-blue-500" /> Yes</span>
                  </li>
                  <li className="flex justify-between items-center text-sm pb-1 group/item transition-colors">
                    <span className="text-neutral-400 font-medium transition-colors group-hover/item:text-neutral-200">Suitable For</span>
                    <span className="text-white font-medium text-right max-w-[60%] leading-relaxed">Supplementation of botanical herbs and nutrients to support health functions</span>
                  </li>
                </ul>
              </div>
            </FadeInSection>
            ...
            <div className="mb-12">
              <FadeInSection>
                ...
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-8">
                  <strong className="text-white">Label claim:</strong><br />
                  General health
                </p>
              </FadeInSection>
              ...
              <FadeInSection delay="100ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] rounded-xl p-5 flex gap-6 divide-x divide-white/[0.06]">
                  <div className="flex-1">
                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 mb-1">Package Size</h4>
                    <p className="text-sm font-bold text-white">360 / 120 Capsules (300 mg each)</p>
                  </div>
                  <div className="flex-1 pl-6">
                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 mb-1">Shelf Life</h4>
                    <p className="text-sm font-bold text-white">36 months</p>
                  </div>
                </div>
              </FadeInSection>
            </div>
              ...
              <FadeInSection delay="300ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 h-full group">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-blue-500/50 pl-3">
                    <Leaf className="w-4 h-4 text-blue-500" /> Ingredients
                  </h3>
                      ...
                      <div className="space-y-4">
                        <div className="flex gap-4 items-start">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-neutral-400">3 to 6 capsule a day</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="group/item mt-6 pt-6 border-t border-white/[0.08]">
                    ...
                    <div className="bg-white/[0.02] border border-white/[0.06] p-3 rounded-lg flex items-center gap-3">
                      ...
                      <p className="text-xs text-neutral-400 leading-normal">
                        Ambient Conditions And Moisture Free
                      </p>
                    </div>
                  </div>
                  
                  <div className="group/item mt-4 pt-4 border-t border-white/[0.08]">
                    <h5 className="font-bold text-white mb-3 uppercase text-[9px] tracking-widest group-hover/item:text-amber-400 transition-colors text-amber-500 flex items-center gap-2"><AlertTriangle className="w-3 h-3" /> Caution</h5>
                    <p className="text-xs text-neutral-400 leading-normal">
      ...
      <ProductReviews productName="DXN SPIRULINA CAPSULE - 360 / 120 No's" />
    </div>
  );
};

export default SpirulinaCapsule;
