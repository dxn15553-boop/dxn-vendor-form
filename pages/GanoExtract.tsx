...
const GanoExtract: React.FC = () => {
  return (
    <div className="bg-neutral-950 text-neutral-300 overflow-hidden perspective-1000 pb-16">
        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 md:px-12">
          ...
          <div className="block lg:hidden flex flex-col items-center text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-rose-500/20 bg-rose-500/5 backdrop-blur-sm mb-6">
              ...
              <span className="text-xs font-black uppercase tracking-[0.3em] text-rose-400">Cosmetics Division</span>
            </div>
            <h1 className="text-5xl sm:text-6xl font-black tracking-tighter uppercase leading-[0.9] text-white">
              DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-rose-600 drop-shadow-lg">GANO</span><br />
              <span className="text-3xl sm:text-4xl text-white/50 tracking-tight">EXTRACT</span>
            </h1>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-20 items-center">
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    ...
                    <div className="hidden lg:flex flex-col items-start">
                      ...
                      <h1 className="text-5xl md:text-7xl lg:text-[5rem] font-black tracking-tighter uppercase leading-[0.9] mb-8 text-white">
                        DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-rose-600 drop-shadow-lg">GANO</span><br />
                        <span className="text-3xl md:text-5xl text-white/50 tracking-tight">EXTRACT</span>
                      </h1>
                    </div>
                    ...
                    <p className="text-neutral-300 max-w-xl text-lg md:text-xl font-light leading-relaxed mb-10 transition-all duration-300 hover:text-white">
                      Gano Extract is a natural health supplement derived from the fruiting body of Ganoderma lucidum. This medicinal mushroom has been used for centuries for its adaptogenic and immune-modulating properties. The extract is typically standardized to contain beneficial polysaccharides, triterpenoids, and antioxidants.
                    </p>
            ...
            <div className="order-1 lg:order-2 w-full flex justify-center lg:justify-end">
              <FadeInSection delay="200ms">
                <div className="relative w-full max-w-sm aspect-[4/5] lg:aspect-square group">
                  {/* Image Container */}
                  <div className="relative w-full h-full flex items-center justify-center transform transition-transform duration-700 hover:scale-[1.05]">
                    <img
                      src="/agro/ganoextract.png"
                      alt="DXN GANO EXTRACT"
                      onError={(e) => {
                        const target = e.target as HTMLImageElement;
                        target.src = 'https://images.unsplash.com/photo-1628102491629-778571d893a3?q=80&w=800&auto=format&fit=crop';
                      }}
                      className="w-full h-full object-contain scale-[1.0] filter drop-shadow-[0_20px_40px_rgba(244,63,94,0.3)]"
                    />
                  </div>
                </div>
              </FadeInSection>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24 self-start">
              ...
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                ...
                <ul className="space-y-4 relative z-10">
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-rose-500/20">
                    ...
                    <span className="text-white font-medium text-right">Viscous liquid with a smooth consistency</span>
                  </li>
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-rose-500/20">
                    <span className="text-neutral-400 font-medium transition-colors group-hover/item:text-neutral-200">Colour and Odour</span>
                    <span className="text-white font-medium text-right">Light brown colour, characteristic earthy, woody aroma with slightly bitter</span>
                  </li>
                  <li className="flex justify-between items-center text-sm pb-1 group/item transition-colors">
                    ...
                    <span className="text-white font-medium text-right">FSSAI / Health supplement</span>
                  </li>
                </ul>
              </div>
            </FadeInSection>
            ...
            <FadeInSection delay="300ms">
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 transition-colors group-hover:text-white border-l-2 border-rose-600/50 pl-3">
                  <Package className="w-4 h-4 text-rose-600" /> Storage Condition
                </h3>
          ...
          <div className="lg:col-span-7">
            <div className="mb-12">
              <FadeInSection>
                <h2 className="text-2xl sm:text-3xl font-extrabold uppercase tracking-tight text-white mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-neutral-400">Health Benefits</h2>
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-8">
                  It's rich in bioactive compounds and has various potential health benefits. The antioxidant and anti-inflammatory properties of Ganoderma and sesame oil may help soothe skin irritations and promote healthy skin. Traditionally used for overall wellbeing. Infused with sesame oil for enhanced absorption and wellness support.
                </p>
              </FadeInSection>
              ...
              <FadeInSection delay="100ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] rounded-xl p-5 flex gap-6 divide-x divide-white/[0.06]">
                  ...
                  <div className="flex-1 pl-6">
                    ...
                    <p className="text-base font-bold text-white">Health supplement / Cosmetics</p>
                  </div>
                </div>
              </FadeInSection>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <FadeInSection delay="300ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 h-full group">
                  ...
                  <div className="mt-4 pt-4 border-t border-white/[0.08]">
                    <h4 className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 mb-2">Allergen Content</h4>
                    <p className="text-sm font-medium text-rose-400">Contains sesamum</p>
                  </div>
                </div>
              </FadeInSection>
              ...
              <FadeInSection delay="400ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 h-full group">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-rose-500/50 pl-3">
                    <Droplet className="w-4 h-4 text-rose-500" /> Directions for Use
                  </h3>
                  <div className="space-y-6 text-sm text-neutral-300">
                    <div className="group/item">
                      <p className="font-medium text-white mb-4 transition-colors">
                        Take 1-2 ml of Gano extract diluted in 100 ml of water or edible oils.
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <ProductReviews productName="DXN GANO EXTRACT" />
    </div >
  );
};

export default GanoExtract;
