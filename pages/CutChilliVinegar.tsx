            ...
            <div className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FadeInSection delay="100ms">
                  <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] border-l-[3px] border-l-green-600 p-6 rounded-xl transition-all duration-500 hover:border-l-green-500 hover:bg-neutral-900/50 hover:shadow-[0_15px_30px_rgba(0,0,0,0.3)] hover:-translate-y-0.5">
                ...
                <FadeInSection delay="200ms">
                  <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] border-l-[3px] border-l-green-600 p-6 rounded-xl transition-all duration-500 hover:border-l-green-500 hover:bg-neutral-900/50 hover:shadow-[0_15px_30px_rgba(0,0,0,0.3)] hover:-translate-y-0.5">
                    ...
                    <p className="text-lg font-bold text-white">Spicy seasoning</p>
                  </div>
                </FadeInSection>
              </div>
            </div>
