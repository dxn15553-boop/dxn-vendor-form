...
const HibiscusTea: React.FC = () => {
  return (
    <div className="bg-neutral-950 text-neutral-300 overflow-hidden perspective-1000 pb-16">
        ...
        <div className="relative z-10 max-w-[1440px] w-full mx-auto px-6 md:px-12">
          ...
          <div className="block lg:hidden flex flex-col items-center text-center mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-rose-500/20 bg-rose-500/5 backdrop-blur-sm mb-6">
              <Coffee className="w-4 h-4 text-rose-500 animate-pulse" />
              <span className="text-xs font-black uppercase tracking-[0.3em] text-rose-400">Coffee & Tea Division</span>
            </div>
            <h1 className="text-5xl sm:text-6xl font-black tracking-tighter uppercase leading-[0.9] text-white">
              DXN <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-rose-600 drop-shadow-lg">Hibiscus Floral Tea</span>
            </h1>
          </div>
                ...
                <div className="bg-neutral-900/30 backdrop-blur-xl border border-white/[0.08] p-6 md:p-8 rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.8)] relative overflow-hidden group hover:border-rose-500/30 transition-all duration-700">
                  ...
                  <div className="relative z-10 flex flex-col items-start">
                    ...
                    <p className="text-neutral-300 max-w-xl text-lg md:text-xl font-light leading-relaxed mb-10 transition-all duration-300 hover:text-white">
                      Each paper canister box contains 30g of premium dried Hibiscus flowers, derived from the Hibiscus Rosa-Sinensis.
                    </p>
              ...
              <FadeInSection delay="200ms">
                <div className="relative w-full max-w-lg aspect-[4/5] lg:aspect-square group">
                  ...
                  <div className="relative w-full h-full flex items-center justify-center transform transition-transform duration-700 hover:scale-[1.05]">
                    <img
                      src="/coffee/hibiscus.png"
                      alt="DXN Hibiscus Floral Tea Packaging"
                      className="w-full h-full object-contain scale-[1.1] md:scale-[1.15] filter drop-shadow-[0_20px_40px_rgba(244,63,94,0.3)]"
                    />
                  </div>
                </div>
              </FadeInSection>
          ...
          <div className="lg:col-span-5 space-y-8 lg:sticky lg:top-24 self-start">
            <FadeInSection>
              ...
              <div className="relative group">
                ...
                <div className="absolute -inset-2 bg-gradient-to-r from-rose-500/5 to-red-500/5 rounded-3xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-1000 pointer-events-none"></div>

                {/* Inner stable Product Container with Glassmorphism */}
                <div
                  className="bg-neutral-900/25 backdrop-blur-xl border border-white/[0.06] p-2 md:p-4 rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.4)] relative overflow-hidden transition-all duration-500 hover:border-rose-500/20 hover:shadow-[0_25px_60px_rgba(0,0,0,0.5)]"
                >
                  {/* Ambient glow */}
                  ...
                  <div className="relative z-10 w-full aspect-video rounded-2xl overflow-hidden shadow-2xl bg-black border border-white/5 flex items-center justify-center">
                    <video
                      src="/coffee/Hibiscus_flowers.mp4"
              ...
              <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_15px_40px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                ...
                <ul className="space-y-4 relative z-10">
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-rose-500/20">
                    ...
                    <span className="text-white font-medium text-right">Dried Hibiscus flowers</span>
                  </li>
                  <li className="flex justify-between items-center text-sm border-b border-white/[0.04] pb-3 group/item transition-colors hover:border-rose-500/20">
                    <span className="text-neutral-400 font-medium transition-colors group-hover/item:text-neutral-200">Colour and Odour</span>
                    <span className="text-white font-medium text-right">Crimson red, fragrant floral aroma</span>
                  </li>
            ...
            <FadeInSection delay="300ms">
              <div className="bg-neutral-900/30 backdrop-blur-xl border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-rose-500/25 hover:shadow-[0_20px_50px_rgba(244,63,94,0.06)] hover:-translate-y-0.5 relative overflow-hidden group">
                <div className="absolute -top-12 -right-12 w-32 h-32 bg-rose-500/5 rounded-full blur-2xl group-hover:bg-rose-500/10 transition-colors duration-500"></div>
                ...
                <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-rose-500/50 pl-3">
                  <ShieldCheck className="w-4 h-4 text-rose-500" /> Servings Information
                </h3>
            ...
            <div className="mb-12">
              <FadeInSection>
                ...
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-6">
                  DXN Hibiscus Floral Tea is derived from the dried flowers of Hibiscus Rosa-Sinensis. This full-bodied flower produces a brilliant crimson-red tea featuring a tangy-sweet flavor that is absolutely satisfying at any time of day.
                </p>
                <p className="text-neutral-300 text-base md:text-lg font-light leading-relaxed mb-8">
                  DXN Hibiscus Floral tea comes from the dried flowers of the hibiscus rosa-sinensis. This full-bodied flower offers a wonderful crimson red color tea. DXN Hibiscus Floral Tea, promises a satisfying and tangy-sweet experience for any moment of the day. DXN Hibiscus Floral Tea is rich in antioxidants that prevent the damage of cells.
                </p>
              </FadeInSection>
            ...
            <div className="grid grid-cols-1 gap-6 mb-12">
              ...
              <FadeInSection delay="200ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 group">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-rose-500/50 pl-3">
                    <HeartPulse className="w-4 h-4 text-rose-500" /> Health Benefits
                  </h3>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                    {[
                      { title: 'Rich in Antioxidants', desc: 'Helps fight free radicals and supports healthy cells.' },
                      { title: 'Supports Heart Health', desc: 'May help lower blood pressure and cholesterol.' },
                      { title: 'Boosts Immunity', desc: 'High in vitamin C to strengthen the immune system.' },
                      { title: 'Aids Digestion', desc: 'Promotes digestive health and regular bowel movements.' },
                      { title: 'Supports Healthy Skin', desc: 'Antioxidants help reduce signs of aging.' },
                    ].map((benefit, idx) => (
                      <div key={idx} className="flex flex-col gap-1 p-3 bg-white/[0.02] border border-white/[0.04] rounded-lg hover:border-rose-500/20 transition-colors">
                        <span className="text-sm font-bold text-white flex items-center gap-2">
                          <Check className="w-3.5 h-3.5 text-rose-500" /> {benefit.title}
                        </span>
                        <span className="text-xs text-neutral-400 pl-5.5">{benefit.desc}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <FadeInSection delay="300ms">
                <div className="bg-neutral-900/30 backdrop-blur-md border border-white/[0.06] p-6 md:p-8 rounded-2xl transition-all duration-500 hover:border-white/15 hover:bg-neutral-900/50 hover:shadow-[0_20px_45px_rgba(0,0,0,0.3)] hover:-translate-y-0.5 h-full group">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-neutral-300 border-b border-white/[0.08] pb-4 mb-6 flex items-center gap-2.5 border-l-2 border-rose-500/50 pl-3">
                    <Coffee className="w-4 h-4 text-rose-500" /> Ingredients
                  </h3>
                  <ul className="space-y-4">
                    <li className="flex items-start gap-3 text-sm group/item">
                      <Check className="w-4 h-4 text-rose-500 shrink-0 mt-0.5" />
                      <span className="font-semibold text-white block group-hover/item:translate-x-1 transition-transform">Sun Dried Hibiscus flowers</span>
                    </li>
                  </ul>
                </div>
              </FadeInSection>
                  ...
                  <div className="space-y-6 text-sm text-neutral-300">
                    <div className="group/item">
                      ...
                      <div className="space-y-4">
                        {[
                          { step: 1, label: 'Add Flowers', desc: 'Add 5-6 dried DXN Hibiscus flowers to 150 ml of hot water.' },
      ...
      <ProductReviews productName="Hibiscus Floral Tea" />
    </div>
  );
};

export default HibiscusTea;
