               ...
               >
                  {filteredProducts.map((product, idx) => (
                     ...
                     >
                        ...
                        {/* Image Area */}
                        <div className="h-80 relative overflow-hidden bg-black flex items-center justify-center p-6">
                           {product.image ? (
                              <img
                                 src={product.image}
                                 alt={product.name}
         ...
         {selectedProduct && (
            <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/90 backdrop-blur-md transition-opacity duration-500" onClick={handleCloseModal}>
               ...
               >
                  ...
                  {/* Image Side */}
                  <div className="relative h-80 lg:h-[500px] bg-neutral-950 flex items-center justify-center overflow-hidden p-8">
                     {selectedProduct.image ? (
                        <img
                           src={selectedProduct.image}
                           alt={selectedProduct.name}
                           className="max-h-[85%] max-w-[85%] object-contain opacity-95 transition-transform duration-500 hover:scale-[1.03]"
                        />
                     ) : (
