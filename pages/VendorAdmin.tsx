...
Please log in to the DXN Vendor Registration Portal (https://www.dxnmanufacturing.com/vendor/register) and upload the pending documents to complete your registration process.
                     ...
                     <div className="min-w-[960px]">
                        ...
                        {!isLoadingVendors && pageVendors.map((vendor, idx) => {
                           ...
                           return (
                              <div
                                 key={vendor.id}
                                 className={`vendor-row grid gap-2 px-5 py-4 items-center border-b border-emerald-500/50 last:border-0 transition-all duration-200 group ${isSelected ? 'bg-red-600/10' :
                              ...
                              {(() => {
                                 ...
                                 return pages.map((p, i) => p === '...' ? (
                                    ...
                                    <button key={p}
                                       ...
                                       className={`w-8 h-8 rounded-full text-xs font-bold transition-all ${p === vendorPage
